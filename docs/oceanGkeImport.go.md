...
```go
import "github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8/oceangkeimport"
...
&oceangkeimport.OceanGkeImportAutoscaler {
	...
	Cooldown: *f64,
	Down: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8.oceanGkeImport.OceanGkeImportAutoscalerDown,
	EnableAutomaticAndManualHeadroom: interface{},
	Headroom: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8.oceanGkeImport.OceanGkeImportAutoscalerHeadroom,
	IsAutoConfig: interface{},
	IsEnabled: interface{},
	ResourceLimits: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8.oceanGkeImport.OceanGkeImportAutoscalerResourceLimits,
}
```
...
&oceangkeimport.OceanGkeImportConfig {
	...
	ClusterName: *string,
	Location: *string,
	Autoscaler: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8.oceanGkeImport.OceanGkeImportAutoscaler,
	...
	ShieldedInstanceConfig: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8.oceanGkeImport.OceanGkeImportShieldedInstanceConfig,
	Strategy: interface{},
	UpdatePolicy: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8.oceanGkeImport.OceanGkeImportUpdatePolicy,
...
&oceangkeimport.OceanGkeImportScheduledTask {
	ShutdownHours: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8.oceanGkeImport.OceanGkeImportScheduledTaskShutdownHours,
	Tasks: interface{},
}
```
...
&oceangkeimport.OceanGkeImportScheduledTaskTasks {
	...
	IsEnabled: interface{},
	TaskType: *string,
	TaskParameters: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8.oceanGkeImport.OceanGkeImportScheduledTaskTasksTaskParameters,
}
```
...
&oceangkeimport.OceanGkeImportScheduledTaskTasksTaskParameters {
	ClusterRoll: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8.oceanGkeImport.OceanGkeImportScheduledTaskTasksTaskParametersClusterRoll,
}
```
...
&oceangkeimport.OceanGkeImportUpdatePolicy {
	...
	RollConfig: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8.oceanGkeImport.OceanGkeImportUpdatePolicyRollConfig,
}
```
