...
```go
import "github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8/multairoutingrule"
...
| <code><a href="#@cdktf/provider-spotinst.multaiRoutingRule.MultaiRoutingRuleConfig.property.priority">Priority</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.122.2/docs/resources/multai_routing_rule#priority MultaiRoutingRule#priority}. |
