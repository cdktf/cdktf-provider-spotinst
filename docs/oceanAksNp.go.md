...
```go
import "github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v5/oceanaksnp"
...
&oceanaksnp.OceanAksNpAutoscaler {
	AutoscaleDown: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v5.oceanAksNp.OceanAksNpAutoscalerAutoscaleDown,
	AutoscaleHeadroom: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v5.oceanAksNp.OceanAksNpAutoscalerAutoscaleHeadroom,
	AutoscaleIsEnabled: interface{},
	ResourceLimits: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v5.oceanAksNp.OceanAksNpAutoscalerResourceLimits,
}
```
...
&oceanaksnp.OceanAksNpAutoscalerAutoscaleHeadroom {
	Automatic: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v5.oceanAksNp.OceanAksNpAutoscalerAutoscaleHeadroomAutomatic,
}
```
...
&oceanaksnp.OceanAksNpConfig {
	...
	Name: *string,
	Autoscaler: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v5.oceanAksNp.OceanAksNpAutoscaler,
	AvailabilityZones: *[]*string,
	ControllerClusterId: *string,
	EnableNodePublicIp: interface{},
	FallbackToOndemand: interface{},
	Health: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v5.oceanAksNp.OceanAksNpHealth,
	Id: *string,
