...
```go
import "github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8/mrscaleraws"
...
&mrscaleraws.MrscalerAwsConfig {
	...
	MasterTarget: *f64,
	ProvisioningTimeout: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8.mrscalerAws.MrscalerAwsProvisioningTimeout,
	Region: *string,
	ReleaseLabel: *string,
