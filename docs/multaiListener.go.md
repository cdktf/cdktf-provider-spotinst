...
```go
import "github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v6/multailistener"
...
&multailistener.MultaiListenerConfig {
	...
	Id: *string,
	Tags: interface{},
	TlsConfig: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v6.multaiListener.MultaiListenerTlsConfig,
}
```
