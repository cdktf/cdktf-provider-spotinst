...
```go
import "github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8/multailistener"
...
&multailistener.MultaiListenerConfig {
	...
	Id: *string,
	Tags: interface{},
	TlsConfig: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8.multaiListener.MultaiListenerTlsConfig,
}
```
