...
| <code><a href="#@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.addMoveTarget">addMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.importFrom">importFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.moveTo">moveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
...
##### `addMoveTarget` <a name="addMoveTarget" id="@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.addMoveTarget.parameter.moveTarget"></a>
...
##### `importFrom` <a name="importFrom" id="@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.importFrom"></a>

```typescript
public importFrom(id: string, provider?: TerraformProvider): void
```

###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.importFrom.parameter.id"></a>

- *Type:* string

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.importFrom.parameter.provider"></a>
...
##### `moveTo` <a name="moveTo" id="@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.moveTo.parameter.moveTarget"></a>
...
###### `index`<sup>Optional</sup> <a name="index" id="@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.moveTo.parameter.index"></a>
...
| <code><a href="#@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.generateConfigForImport">generateConfigForImport</a></code> | Generates CDKTF code for importing a MultaiDeployment resource upon running "cdktf plan <stack-name>". |
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.generateConfigForImport"></a>
...
###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing MultaiDeployment that should be imported.

Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.148.0/docs/resources/multai_deployment#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.generateConfigForImport.parameter.provider"></a>
...
| <code><a href="#@cdktf/provider-spotinst.multaiDeployment.MultaiDeployment.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-spotinst.multaiDeployment.MultaiDeploymentConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-spotinst.multaiDeployment.MultaiDeploymentConfig.property.name">name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.148.0/docs/resources/multai_deployment#name MultaiDeployment#name}. |
| <code><a href="#@cdktf/provider-spotinst.multaiDeployment.MultaiDeploymentConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.148.0/docs/resources/multai_deployment#id MultaiDeployment#id}. |
