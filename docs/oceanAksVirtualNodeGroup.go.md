...
```go
import "github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8/oceanaksvirtualnodegroup"
...
&oceanaksvirtualnodegroup.OceanAksVirtualNodeGroupLaunchSpecification {
	MaxPods: *f64,
	OsDisk: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v8.oceanAksVirtualNodeGroup.OceanAksVirtualNodeGroupLaunchSpecificationOsDisk,
	Tag: interface{},
}
```
