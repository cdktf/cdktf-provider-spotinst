...
&oceanspark.OceanSparkConfig {
	...
	Workspaces: github.com/cdktf/cdktf-provider-spotinst-go/spotinst.oceanSpark.OceanSparkWorkspaces,
}
```
...
&oceanspark.OceanSparkWorkspaces {
	Storage: github.com/cdktf/cdktf-provider-spotinst-go/spotinst.oceanSpark.OceanSparkWorkspacesStorage,
}
```
...
&oceanspark.OceanSparkWorkspacesStorage {
	Defaults: github.com/cdktf/cdktf-provider-spotinst-go/spotinst.oceanSpark.OceanSparkWorkspacesStorageDefaults,
}
```
