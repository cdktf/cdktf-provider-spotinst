...
&oceanspark.OceanSparkConfig {
	...
	Workspaces: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v13.oceanSpark.OceanSparkWorkspaces,
}
```
...
&oceanspark.OceanSparkWorkspaces {
	Storage: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v13.oceanSpark.OceanSparkWorkspacesStorage,
}
```
...
&oceanspark.OceanSparkWorkspacesStorage {
	Defaults: github.com/cdktf/cdktf-provider-spotinst-go/spotinst/v13.oceanSpark.OceanSparkWorkspacesStorageDefaults,
}
```
