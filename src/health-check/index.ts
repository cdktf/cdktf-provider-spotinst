...
// https://registry.terraform.io/providers/spotinst/spotinst/1.213.1/docs/resources/health_check
...
export class HealthCheck extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HealthCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.213.1/docs/resources/health_check#import import section} in the documentation of this resource for the id to use
