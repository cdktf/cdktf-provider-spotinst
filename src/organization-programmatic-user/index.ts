// https://registry.terraform.io/providers/spotinst/spotinst/1.192.0/docs/resources/organization_programmatic_user
...
export class OrganizationProgrammaticUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationProgrammaticUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.192.0/docs/resources/organization_programmatic_user#import import section} in the documentation of this resource for the id to use
