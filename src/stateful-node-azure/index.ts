// https://registry.terraform.io/providers/spotinst/spotinst/1.186.0/docs/resources/stateful_node_azure
...
export class StatefulNodeAzure extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StatefulNodeAzure that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.186.0/docs/resources/stateful_node_azure#import import section} in the documentation of this resource for the id to use
