// https://registry.terraform.io/providers/spotinst/spotinst/1.205.1/docs/resources/ocean_gke_launch_spec_import
...
export class OceanGkeLaunchSpecImport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OceanGkeLaunchSpecImport that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.205.1/docs/resources/ocean_gke_launch_spec_import#import import section} in the documentation of this resource for the id to use
