// https://registry.terraform.io/providers/spotinst/spotinst/1.160.0/docs/resources/elastigroup_aws_beanstalk
...
export class ElastigroupAwsBeanstalk extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElastigroupAwsBeanstalk that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.160.0/docs/resources/elastigroup_aws_beanstalk#import import section} in the documentation of this resource for the id to use
