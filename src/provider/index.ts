...
// https://registry.terraform.io/providers/spotinst/spotinst/1.219.0/docs
...
export class SpotinstProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing SpotinstProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.219.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.219.0/docs spotinst} Resource
  *
  * @param scope The scope in which to define this construct
