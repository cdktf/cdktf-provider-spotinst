...
// https://registry.terraform.io/providers/spotinst/spotinst/1.165.1/docs/resources/elastigroup_azure
...
export class ElastigroupAzure extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElastigroupAzure that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.165.1/docs/resources/elastigroup_azure#import import section} in the documentation of this resource for the id to use
