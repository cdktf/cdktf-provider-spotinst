...
// https://registry.terraform.io/providers/spotinst/spotinst/1.187.0/docs/resources/credentials_gcp
...
export class CredentialsGcp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CredentialsGcp that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.187.0/docs/resources/credentials_gcp#import import section} in the documentation of this resource for the id to use
