...
// https://registry.terraform.io/providers/spotinst/spotinst/1.188.1/docs/resources/credentials_gcp
...
export class CredentialsGcp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CredentialsGcp that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.188.1/docs/resources/credentials_gcp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.188.1/docs/resources/credentials_gcp spotinst_credentials_gcp} Resource
  *
  * @param scope The scope in which to define this construct
