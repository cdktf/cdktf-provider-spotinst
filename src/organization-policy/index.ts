// https://registry.terraform.io/providers/spotinst/spotinst/1.172.3/docs/resources/organization_policy
...
export class OrganizationPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.172.3/docs/resources/organization_policy#import import section} in the documentation of this resource for the id to use
