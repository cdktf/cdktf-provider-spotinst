// https://registry.terraform.io/providers/spotinst/spotinst/1.156.0/docs/resources/elastigroup_aws
...
export class ElastigroupAws extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElastigroupAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.156.0/docs/resources/elastigroup_aws#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.156.0/docs/resources/elastigroup_aws spotinst_elastigroup_aws} Resource
  *
  * @param scope The scope in which to define this construct
