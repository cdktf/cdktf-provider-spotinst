...
// https://registry.terraform.io/providers/spotinst/spotinst/1.151.1/docs/resources/account_aws
...
export class AccountAws extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.151.1/docs/resources/account_aws#import import section} in the documentation of this resource for the id to use
