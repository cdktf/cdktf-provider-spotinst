// https://registry.terraform.io/providers/spotinst/spotinst/1.167.1/docs/resources/organization_user
...
export class OrganizationUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.167.1/docs/resources/organization_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.167.1/docs/resources/organization_user spotinst_organization_user} Resource
  *
  * @param scope The scope in which to define this construct
