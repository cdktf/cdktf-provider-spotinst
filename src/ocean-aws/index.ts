...
// https://registry.terraform.io/providers/spotinst/spotinst/1.225.0/docs/resources/ocean_aws
...
export class OceanAws extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OceanAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.225.0/docs/resources/ocean_aws#import import section} in the documentation of this resource for the id to use
