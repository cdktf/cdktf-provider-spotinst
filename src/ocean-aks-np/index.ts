...
// https://registry.terraform.io/providers/spotinst/spotinst/1.168.2/docs/resources/ocean_aks_np
...
export class OceanAksNp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OceanAksNp that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.168.2/docs/resources/ocean_aks_np#import import section} in the documentation of this resource for the id to use
