...
// https://registry.terraform.io/providers/spotinst/spotinst/1.187.0/docs/resources/mrscaler_aws
...
export class MrscalerAws extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MrscalerAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.187.0/docs/resources/mrscaler_aws#import import section} in the documentation of this resource for the id to use
