...
// https://registry.terraform.io/providers/spotinst/spotinst/1.146.0/docs/resources/multai_target
...
export class MultaiTarget extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MultaiTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.146.0/docs/resources/multai_target#import import section} in the documentation of this resource for the id to use
