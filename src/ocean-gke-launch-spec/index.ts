...
// https://registry.terraform.io/providers/spotinst/spotinst/1.172.3/docs/resources/ocean_gke_launch_spec
...
export class OceanGkeLaunchSpec extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OceanGkeLaunchSpec that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.172.3/docs/resources/ocean_gke_launch_spec#import import section} in the documentation of this resource for the id to use
