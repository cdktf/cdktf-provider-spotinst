...
// https://registry.terraform.io/providers/spotinst/spotinst/1.192.0/docs/resources/oceancd_rollout_spec
...
export class OceancdRolloutSpec extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OceancdRolloutSpec that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.192.0/docs/resources/oceancd_rollout_spec#import import section} in the documentation of this resource for the id to use
