...
// https://registry.terraform.io/providers/spotinst/spotinst/1.146.0/docs/resources/multai_balancer
...
export class MultaiBalancer extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the MultaiBalancer to import
  * @param importFromId The id of the existing MultaiBalancer that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.146.0/docs/resources/multai_balancer#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the MultaiBalancer to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "spotinst_multai_balancer", importId: importFromId, provider });
      }
