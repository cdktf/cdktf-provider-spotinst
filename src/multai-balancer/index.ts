...
// https://registry.terraform.io/providers/spotinst/spotinst/1.148.0/docs/resources/multai_balancer
...
export class MultaiBalancer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MultaiBalancer that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.148.0/docs/resources/multai_balancer#import import section} in the documentation of this resource for the id to use
