// https://registry.terraform.io/providers/spotinst/spotinst/1.153.0/docs/resources/data_integration
...
export class DataIntegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.153.0/docs/resources/data_integration#import import section} in the documentation of this resource for the id to use
