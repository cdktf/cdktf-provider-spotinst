...
// https://registry.terraform.io/providers/spotinst/spotinst/1.176.0/docs/resources/ocean_aks
...
export class OceanAks extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OceanAks that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.176.0/docs/resources/ocean_aks#import import section} in the documentation of this resource for the id to use
