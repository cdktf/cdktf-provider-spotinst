...
// https://registry.terraform.io/providers/spotinst/spotinst/1.147.0/docs/resources/multai_routing_rule
...
export class MultaiRoutingRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MultaiRoutingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.147.0/docs/resources/multai_routing_rule#import import section} in the documentation of this resource for the id to use
