...
// https://registry.terraform.io/providers/spotinst/spotinst/1.146.0/docs/resources/multai_routing_rule
...
export class MultaiRoutingRule extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the MultaiRoutingRule to import
  * @param importFromId The id of the existing MultaiRoutingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.146.0/docs/resources/multai_routing_rule#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the MultaiRoutingRule to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "spotinst_multai_routing_rule", importId: importFromId, provider });
      }
