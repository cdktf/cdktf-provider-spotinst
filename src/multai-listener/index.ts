...
// https://registry.terraform.io/providers/spotinst/spotinst/1.148.0/docs/resources/multai_listener
...
export class MultaiListener extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MultaiListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.148.0/docs/resources/multai_listener#import import section} in the documentation of this resource for the id to use
